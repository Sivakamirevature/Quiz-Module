...
CREATE TABLE `quizzes` (
  ...
  `available_for` varchar(65) NOT NULL,
  `timer_enabled` tinyint(4) DEFAULT NULL,
  `shuffle_questions` tinyint(4) DEFAULT NULL,
  `shuffle_answers` tinyint(4) DEFAULT NULL,
  `display_score` tinyint(4) DEFAULT NULL,
  `allow_attempt_review` tinyint(4) DEFAULT NULL,
  `show_correct_answers_passed` tinyint DEFAULT NULL,
  `show_correct_answers_failed` tinyint DEFAULT NULL,
